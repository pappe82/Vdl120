...
namespace Vdl120io
{
    public class VdlDeviceFactory
    {
        ...
        public VdlDeviceFactory(TimeSpan readTimeout, TimeSpan writeTimeout)
        {
        ...
        public VdlMeasurementReader CreateReader(VdlDevice device) => new(device, _readTimeout, _writeTimeout);
    }
}